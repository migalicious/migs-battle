...
func build_default() -> void:
	...
	scenarios = [
		_make(0, "Border Skirmish",
			...
			[{"class_id": "cleric", "unit_name": "Mira", "level": 4, "is_hero": true}], 0.70),
		_make(1, "The River Crossing",
			...
			[{"class_id": "gryphon_rider", "unit_name": "Aquila", "level": 5, "is_hero": true}], 0.80),
		_make(2, "Uneasy Allies",
			...
			[{"class_id": "sea_knight", "unit_name": "Nerin", "level": 5, "is_hero": true}], 0.90),
		_make(3, "Three Kingdoms",
			...
			[{"class_id": "paladin",  "unit_name": "Garran", "level": 6, "is_hero": true},
			 {"class_id": "sorcerer", "unit_name": "Vesna",  "level": 6, "is_hero": true}], 0.93),
		_make(4, "The Shadow Rises",
			...
			[{"class_id": "witch",   "unit_name": "Hilda", "level": 6, "is_hero": true},
			 {"class_id": "cavalry", "unit_name": "Brunn", "level": 6, "is_hero": true}], 0.92),
